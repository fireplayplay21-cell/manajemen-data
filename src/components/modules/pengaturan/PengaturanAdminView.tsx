          ...
          <div className="p-5 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-1 max-w-2xl leading-relaxed">
                    Bila diaktifkan, setiap guru yang login dengan akunnya <strong>hanya dapat melihat data dan instrumen hasil supervisi miliknya sendiri</strong> (berdasarkan NIP & nama guru). Rekan guru lain tidak dapat melihat lembar evaluasi tersebut demi etika penilaian. Administrator dan Kepala Sekolah tetap memiliki akses lengkap ke semua dokumen.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 shrink-0 self-start sm:self-center">
                <button
                  type="button"
                  id="btn-toggle-supervisi-privacy"
                  onClick={() => {
                    toggleSupervisiPrivacy();
                    showToast(
                      'success',
